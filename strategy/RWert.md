...
<script id="MathJax-script" async src="https://cdn.jsdelivr.net/npm/mathjax@3.0.1/es5/tex-mml-chtml.js"></script>
 ...
 @import url("https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700");
  ...
  <body>
    <div style="display:flex;"><h2>R-Wert</h2> <a href="main" style="margin-left:2em;padding:3px 6px 0 6px;background-color:#888;color:#fff;font-weight:300;">Zurück</a></div>
    <div class="twocol">
    <div class="ntext">
